...
- 1751 Highways 求出方案
- 1182 食物链 种类并查集
- 1456 Supermarket 贪心+区间合并
- 1703 种类并查集
- 1988 种类并查集
- 1733 Parity game 种类并查集，先要离散化一下，不影响结果
- 1417 True Liars(难) 并查集+DP 种类并查集
- 2912 Rochambeau(难) baidu的题,很不错...是食物链的加强版.判断裁判比较难想.
- 2728 Desert King(中等) 最优比率生成树
- 1639 Picnic Planning(较难) 顶点度数有限制的最小生成树
- 3164 Command Network(难) 最小树形图
...
- 4179 Difficult Routes 开二维状态的最短路(带限制最短路)
