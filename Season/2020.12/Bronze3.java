...
public class Bronze3 {
    public static void main(String[] args) throws Exception {
        ...
        for(int i=n-2; i>=0; i--)
            // for each cow c[i], we need to check all cows having higher ranks than her
            for(int j=i+1; j<n; j++) {
                
                // we only need to see if cow[i] and cow[j] are walking differnt directions:
                if (c[i][2] == 1 && c[j][2] == 2)
